...
def post_update(request,slug =None):
	...
	if request.user != instance.user:
		 return render(request,"message.html",{"message":"Contact Anubhav Ph: 9453906150 ps: he is a part time iitk student Please feel free to contact him anytime.","dashboard":domain,"logoutlink":logoutlink})
